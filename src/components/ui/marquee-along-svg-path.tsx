...
// Componente de 21st.dev: "Marquee along SVG path".
// Nota: llama hooks dentro de items.map(); es intencional y seguro porque el
// número de items es estable en runtime (children * repeat constantes). Por eso
// se desactiva react-hooks/rules-of-hooks solo en este archivo.
// Import adaptado de "motion/react" → "framer-motion" (misma API, ya instalada).
